/*********************************************************************************************************
DESCRIPTION: File where you can specify arguments needed to build the social investment data foundation for
	the child cohort
...
data work.control_file_long;
	...
	datalines;
si_debug,False
si_pop_table_out,si_child_cohort
si_id_col,snz_uid
si_asat_date,birth_date
si_num_periods_before,0
